...
namespace BK
{
    public class RoomManager : NetworkBehaviour
    {
        ...
        private void SpawnRoomGeometry(RoomTemplateSO template)
        {
            ...
            {
                Debug.LogError("[RoomManager] SpawnRoomGeometry failed: roomPrefab is null.");
                return;
            }
        ...
        private void WarpAllPlayersToRoom()
        {
            ...
            {
                Debug.LogError("[RoomManager] WarpAllPlayersToRoom failed: NetworkManager.Singleton is null.");
                return;
            }
            ...
            for (int i = 0; i < clients.Count; i++)
            {
                ...
                if (spawnPoint == null)
                {
                    Debug.LogWarning($"[RoomManager] Missing player spawn point for player index {i}.");
                    continue;
                }
